...
- นับ autonomy แยกสองกอง: **ROUTINE_AUTONOMY** (11/11 อัตโนมัติ) กับ **EXCEPTION_GATES** (MFA/CAPTCHA/reauth/ยืนยันความเป็นเจ้าของ/บัญชีถูกจำกัด/ข้อพิพาท/KDP ที่ย้อนไม่ได้/ใส่ secret ครั้งแรก) — gate ไม่หักเปอร์เซ็นต์ แต่ต้องมองเห็นและ fail closed
- iCloud = **ONE_TIME_SETUP_PENDING** ไม่ใช่งานประจำ · ถามครั้งเดียวพอ ห้ามถามซ้ำ · ระหว่างนี้ roster 08:45 คือแหล่งความปลอดภัย KDP · ⛔ ห้ามผ่อน KDP freeze เพราะอ่านเมลไม่ได้
- Day 30 ทำแค่ตั้งธง: CONTINUE → `phase2_unlocked` · ITERATE → `iteration_plan` (คำนวณในเครื่อง ไม่เรียกโมเดล ไม่เพิ่มแพลตฟอร์ม) · INCONCLUSIVE → ไม่ขยายอะไร · STOP-CHANNEL → ปิดช่องทาง
- ⛔ ห้ามสร้างเครื่องผลิตคอนเทนต์ก่อน day 30 · ห้ามเพิ่ม browser automation / Pinterest API / OAuth / LinkedIn / KDP automation เพื่อไล่ตามเปอร์เซ็นต์
